...
def summarize_tart_run(args):
    ...
    console.print(
        f"[bright_green] {tart} [/bright_green] mode {'test' if args.test else 'train'}"
    )
    ...
    console.print(
        f"[bright_green] {tart} [/bright_green] n_train {args.n_batches} x {args.batch_size} = {args.n_train}"
    )
    console.print(
        f"[bright_green] {tart} [/bright_green] n_test 0.2 x {args.n_train} = {args.n_test}"
    )
    console.print(
